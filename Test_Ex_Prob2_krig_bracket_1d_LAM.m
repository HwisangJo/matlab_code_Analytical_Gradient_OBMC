%% MLE inverse problem : KD-estimation (Linear)
clc
close all
clear
...
%%
foldername5=[opt_folder,'\','opt_hist_linear'];
mkdir(foldername5)
for nt=1
% poolobj=parpool(8);
for i=1
...
% lbx=[210e9, 210e9*0.05]*0.5;
% lbx(2)=lbx(2)^2;
% ubx=[210e9, 210e9*0.05]*1.5;
% ubx(2)=ubx(2)^2;
...
obj = @(x) MLE_kerkrig_Ndim_analy_mathe_multi_youn_linear_normal(x,file_exp_name,perf_func); % Likelihood Function Metric(KDE)
