...
function [ff, gg,time_numer]=MLE_kerkrig_Ndim_numer_fdm_corr_parfor(X_,pt,file_exp_name,file_s_name,type_num,perf_func)
...
if nargout > 1 % gradient required
    ...
    for i=1:size(XX,1)
        FF(i,:)=MLE_kerkrig_Ndim_analy_mathe_no_grad_corr_parfor(XX(i,:),file_exp_name,file_s_name,type_num,perf_func);
%         disp('%%%%%%%%%%%%%%%%%%%% function evaluation %%%%%%%%%%%%%%%%%%%%')
    end
