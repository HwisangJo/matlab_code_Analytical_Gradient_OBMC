...
obj = @(x) MLE_kerkrig_Ndim_numer_cvm_corr_parfor(x,10^-15,file_exp_name,file_s_name,type_num_case(nt,:),perf_func); % Likelihood Function Metric(KDE)
...
%     foldername3= [opt_folder,'\','opt_',dist_name_type{nt},sprintf('_inform%d_norm.mat', nt)];
%     foldername3= [opt_folder,'\','opt_',dist_name_type{nt},sprintf('_inform%d_norm_sqp.mat', nt)];
    foldername3= [opt_folder,'\','opt_',dist_name_type{nt},sprintf('_inform%d_%d_norm_trr_cvm.mat', nt,ini)];
%     foldername3= [opt_folder,'\','opt_',dist_name_type{nt},sprintf('_inform%d.mat', nt)];
    load(foldername3)
