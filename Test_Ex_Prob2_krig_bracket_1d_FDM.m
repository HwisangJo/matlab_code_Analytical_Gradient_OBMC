%% MLE inverse problem : KD-estimation (FDM)
clc
close all
clear
...
%%
addpath([pwd,'\imm1460\dace']) % 크리깅 툴박스
...
obj = @(x) MLE_kerkrig_Ndim_numer_fdm_corr_parfor(x,10^-5,file_exp_name,file_s_name,type_num(nt),perf_func); % Likelihood Function Metric(KDE)
